    ...
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://t.me/sahilnolia">
          <h2 class="name">Download Selection</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://www.github.com/sahilgit55"><i class="fab fa-github"></i></a>
        <a href="https://t.me/sahilnolia"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <div id="sticks">
