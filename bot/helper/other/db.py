...
from bot import DATABASE_URL, user_data, DB_NAME, LOGGER, bot_id, config_dict, aria2_options, bot_loop
...
class DbManger:
    ...
    async def drop_db(self):
        if self.__err:
            return
        self.__conn.drop_database(DB_NAME)
        LOGGER.info(f'{DB_NAME} Database successfully deleted')
        self.__conn.close
